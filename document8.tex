...
\begin{abstract}
This is a simple document explaining how to simplify a determinant.
\end{abstract}
...
\begin{aligned}
    ...
    \end{vmatrix}\\ 
    \xleftrightarrow[]{R_1\leftarrow R_1+R_2+R_3}2 \begin{vmatrix}
      (a+b+c) & (p+q+r) & (x+y+z) \\ 
	  c+a & r+p & z+x \\
	  a+b & p+q & x+y \\
    ...
    \end{vmatrix} \\ \xleftrightarrow[]{R_1\leftarrow R_1+R_2+R_3}
    (-1)\times (-1)\times 2 \begin{vmatrix}
      a & p & x \\ 
	  b & q & y \\
	  c & r & z \\
